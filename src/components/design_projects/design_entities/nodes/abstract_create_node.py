...
IAbstractCreateNode = IBaseComponent["AbstractCreateNode.Request", "AbstractCreateNode.Response"]


class AbstractCreateNode(IAbstractCreateNode):
...
AbstractCreateNodeDep = t.Annotated[AbstractCreateNode, Depends()]

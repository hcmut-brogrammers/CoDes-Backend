...
from src.components.design_projects.design_entities.nodes.create_batch_nodes import CreateBatchNodesDep
from src.components.design_projects.design_entities.nodes.create_node import CreateNodeDep
from src.components.design_projects.design_entities.nodes.delete_batch_nodes import DeleteBatchNodesDep
...
from src.components.design_projects.design_entities.nodes.update_batch_nodes import UpdateBatchNodesDep
...
@router.post(
    "/{project_id}" + ApiPath.NODES + "/batch",
    response_model=CreateBatchNodesDep.Response,
    response_model_exclude_none=True,
    response_description="create nodes in a project",
    response_model_by_alias=False,
    status_code=status.HTTP_200_OK,
)
async def create_batch_nodes(
    create_batch_nodes: CreateBatchNodesDep, project_id: UUID, request: CreateBatchNodesDep.HttpRequest
):
    return await create_batch_nodes.aexecute(CreateBatchNodesDep.Request(project_id=project_id, **request.model_dump()))
...
@router.put(
    "/{project_id}" + ApiPath.NODES + "/batch",
    response_model=UpdateBatchNodesDep.Response,
    response_model_exclude_none=True,
    response_description="update nodes in a project",
    response_model_by_alias=False,
    status_code=status.HTTP_200_OK,
)
async def update_batch_nodes(
    update_batch_nodes: UpdateBatchNodesDep, project_id: UUID, request: UpdateBatchNodesDep.HttpRequest
):
    return await update_batch_nodes.aexecute(UpdateBatchNodesDep.Request(project_id=project_id, **request.model_dump()))
...
@router.delete(
    "/{project_id}" + ApiPath.NODES + "/batch",
    response_model=DeleteBatchNodesDep.Response,
    response_model_exclude_none=True,
    response_description="delete nodes in a project",
    response_model_by_alias=False,
    status_code=status.HTTP_200_OK,
)
async def delete_batch_nodes(
    delete_batch_nodes: DeleteBatchNodesDep, project_id: UUID, request: DeleteBatchNodesDep.HttpRequest
):
    return await delete_batch_nodes.aexecute(DeleteBatchNodesDep.Request(project_id=project_id, **request.model_dump()))
